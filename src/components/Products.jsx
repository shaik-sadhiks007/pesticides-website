    ...
    if (showCategories) {
        return (
            <div className="container px-4 py-8 bg-[#DACEC2]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 lg:gap-8 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
                        ...
                        >
                            ...
                            <div className="lg:hidden p-4 md:p-6 flex flex-col sm:flex-row gap-2 sm:gap-3 bg-white">
                                ...
                                >
                                    ...
                                    {cat.id === "agricultureAndHorticulture" ? "Agriculture Catalog" : "Amenity Catalog"}
                                </button>
                            </div>
                        </motion.div>
                    ))}
    ...
    return (
        <div className="container px-4 py-8 bg-[#DACEC2]">
            ...
            >
                ...
                <div className="flex flex-col lg:grid lg:grid-cols-12 gap-4 mb-8 w-full">
