  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 min-h-[100vh] md:min-h-[60vh] lg:min-h-[100vh] w-full">
      ...
      <div className="bg-[#293E31] flex flex-col justify-center items-center p-4 relative group min-h-[50vh] md:min-h-[60vh] w-full">
        ...
        />
        {/* Agriculture Button */}
        <div className="absolute bottom-0 left-0 right-0 flex justify-center items-center p-8 bg-gradient-to-t from-black/30 via-black/20 to-transparent">
          <button
            onClick={() => handleDownload(agricultureCatalog, 'agriculture-catalog.pdf')}
            className="w-full max-w-[300px] cursor-pointer bg-[#FE8340] hover:bg-[#e06724] text-white py-4 px-6 rounded-lg flex items-center justify-center gap-3 transform hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-xl"
          >
      ...
      <div className="relative w-full min-h-[50vh] md:min-h-[60vh] overflow-hidden group">
        ...
        <div className="absolute bottom-0 left-0 right-0 flex justify-center items-center p-8 bg-gradient-to-t from-black/30 via-black/20 to-transparent">
          <button
            ...
            className="w-full max-w-[300px] bg-white cursor-pointer text-[#293E31] px-6 py-4 rounded-lg flex items-center justify-center gap-3 transform hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-xl group/btn"
          >
