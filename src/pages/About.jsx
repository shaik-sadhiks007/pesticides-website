  ...
  return (
    <div className="w-full bg-[#FCF9F4]">
      <div className="w-full ">
        ...
        <section className="py-8 sm:py-12 md:pb-6 md:pt-16 px-4 sm:px-8 md:px-16 flex flex-col items-start justify-center w-full">
          <div className="w-full">
            ...
            <div className="space-y-6 text-justify">
              <p className="text-[#293E31] mb-4 sm:mb-6">
        ...
        {/* Our Mission Section */}
        <section className="py-8 sm:pb-6 md:pb-12 px-4 sm:px-8 md:px-16 flex flex-col items-start justify-center w-full">
          <div className="w-full">
            <h2 className="text-[#293E31] text-2xl sm:text-3xl md:text-4xl font-semibold mb-3 sm:mb-4">
        ...
        <section className="w-full flex flex-col items-center justify-center py-12 sm:py-16 md:py-20 bg-[#DACEC2]">
        ...
        {/* Our Team Section */}
        <section className="w-full flex flex-col items-center justify-center py-12 sm:pb-16 md:pb-20 bg-[#DACEC2]">
          <div className="container px-4 md:px-8">
        ...
        {/* Legacy Section */}
        <section className="w-full py-12 flex flex-col items-center justify-center sm:py-16 md:py-20 bg-[#DACEC2]">
          <div className="container px-4 md:px-8">
            <div className="max-w-6xl mx-auto text-center">
              <h2 className="text-2xl md:text-3xl font-bold text-[#293E31] mb-8">A Legacy of Trust & Innovation</h2>
              <div className="space-y-6 text-justify">
                <p className="text-lg leading-relaxed">
                  With decades of experience in sustainable agriculture, VM ECOGROW has built a reputation as a trusted partner for farmers worldwide. Our extensive distribution network includes partnerships with hundreds of distributors across multiple continents, ensuring timely delivery and localized support wherever you need it.
                </p>
                <p className="text-lg leading-relaxed">
